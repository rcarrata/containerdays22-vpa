...
# NOTE: 
# This demo uses the following prereqs installed 
# needed for running properly the demo
# - Kind
# - Vertical Pod Autoscaler


pei "###########################################"
pei "#      Starting ContainerDays22 Demo      #"
pei "###########################################"

pei "# Deploying applications without VPA"
pe "PROJECT=test-novpa-cd22"
pei ""
